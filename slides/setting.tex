...
\ifdefined\songti\relax\else
  \IfFontExistsTF{SimSun}
    ...
    {
      \setmainfont{Arial}
      \newfontfamily\songti{Arial}
    }
\fi
\linespread{1.5}                        %   调节行距倍数 1.5 倍
...
\setbeamerfont{subtitle}{family=\songti, series=\bfseries, size={\fontsize{24}{0}}}
...
\setbeamerfont{frametitle}{family=\songti, series=\bfseries, size={\fontsize{14}{0}}}
